...
import ToolUser from "../tool/admin/user";
...
@connect((state, props) => {
  return {
    ...
    tableContentObject: state.admin.userList,
  ...
  render() {
    return (
      <div className="main-block" data-nocolumns="true">
        <Route component={ToolUser} limit={this.state.limit} />
        {/* <ToolUser match={this.state.match} limit={this.state.limit} history={this.props.history}/> */}
        <Table
