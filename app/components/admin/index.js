...
export default class Index extends React.Component{
  ...
  selectRenderView(){
    ...
    switch (pageComponent) {
      ...
      case "pageColumn":
        return <PageColumns match={this.props.match} history={this.props.history}/>
        break;
      ...
      case "channel":
        return <Channel match={this.props.match} history={this.props.history}/>
        break;

      case "deductionRule":
        return <DeductionRule match={this.props.match} history={this.props.history}/>
        break;

      case "operationLog":
        return <OperationLog match={this.props.match} history={this.props.history}/>
        break;
  ...
  resetTitle(){
    ...
    let adminNav = this.state.navData.filter((item)=>{ return item.id==8;});
    if( adminNav.length>0 ){
      let filterObject = adminNav[0]['children'].filter((item)=>{ return item.id==page; });
