...
import Tool from "../tool/admin/pageColumn";
...
@connect((state, props) => {
  return {
    ...
    tableContentObject: state.admin.pageColumnList,
    combinationUrl: state.admin.combinationUrl,
    matchPage: state.admin.matchPage
  };
})
export default class PageColumns extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      match: props.match,
      ...
      total: props.total,
      limit: props.limit,
      tableHeader: tableHeader["pageColumns"],
