...
import ToolRole from "../tool/admin/role";
...
@connect((state, props) => {
  return {
    ...
    tableContentObject: state.admin.roleList,
  ...
  render() {
    return (
      <div className="main-block" data-nocolumns="true">
        <Route component={ToolRole} limit={this.state.limit} />
        {/* <ToolRole match={this.state.match} limit={this.state.limit} history={this.props.history}/> */}
        <Table
