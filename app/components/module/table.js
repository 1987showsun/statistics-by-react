...
export default class Table extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (ignoreObjectCount != -1) {
      ...
      dataSource = [
        ...fristDataSource,
        ...sort(newDataSource, key, sortKeyStatus).reSortData
      ];
    } else {
          ...
          return (
            <li key={k}>
              <ul>
                <li
                  className={`t-head`}
                  data-sort={this.state.sortKeyStatus[0][key]}
                  onClick={this.sortData.bind(
                    this,
                    this.props.columns[k]["id"],
                    key
                  )}
                >
  ...
  sortData(id, key) {
    ...
    if (ignoreObjectCount != -1) {
      ...
      dataSource = [
        ...fristDataSource,
        ...sort(newDataSource, key, sortKeyStatus[0][key]).reSortData
      ];
    } else {
