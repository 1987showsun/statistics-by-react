        ...
        <div className={`header ${this.state.navStatus}`}>
          ...
          <div className="right">
            ...
            <div className="setting-box">
              <li className="username">您好！欢迎 <span>{this.state.userInfo['userName']}</span> 用戶</li>
              <ul>
                <li>
                  <NavLink onClick={() => this.handleClick()} to={"/"} className="btn">帐号登出</NavLink>
                </li>
                <li>
                  <span className="btn" onClick={this.updatePassWord.bind(this)}>修改密码</span>
                </li>
              </ul>
            </div>
          </div>
